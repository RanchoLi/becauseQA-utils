...
public class WeatherWebServiceLocator extends org.apache.axis.client.Service implements becausetesting.webserivce.WebXml.WeatherWebService {
 ...
 */
    ...
    public becausetesting.webserivce.WebXml.WeatherWebServiceSoap getWeatherWebServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public becausetesting.webserivce.WebXml.WeatherWebServiceSoap getWeatherWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            becausetesting.webserivce.WebXml.WeatherWebServiceSoapStub _stub = new becausetesting.webserivce.WebXml.WeatherWebServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (becausetesting.webserivce.WebXml.WeatherWebServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                becausetesting.webserivce.WebXml.WeatherWebServiceSoapStub _stub = new becausetesting.webserivce.WebXml.WeatherWebServiceSoapStub(new java.net.URL(WeatherWebServiceSoap_address), this);
                _stub.setPortName(getWeatherWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
