...
public class WeatherWebServiceSoapProxy implements becausetesting.webserivce.WebXml.WeatherWebServiceSoap {
  private String _endpoint = null;
  private becausetesting.webserivce.WebXml.WeatherWebServiceSoap weatherWebServiceSoap = null;
  ...
  private void _initWeatherWebServiceSoapProxy() {
    try {
      weatherWebServiceSoap = (new becausetesting.webserivce.WebXml.WeatherWebServiceLocator()).getWeatherWebServiceSoap();
  ...
  public becausetesting.webserivce.WebXml.WeatherWebServiceSoap getWeatherWebServiceSoap() {
    if (weatherWebServiceSoap == null)
      _initWeatherWebServiceSoapProxy();
