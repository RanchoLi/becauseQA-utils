...
public class ExamplesRunner extends Suite {
    ...
    private BecauseCucumberReporter jUnitReporter;

    protected ExamplesRunner(Runtime runtime, CucumberExamples cucumberExamples, BecauseCucumberReporter jUnitReporter) throws InitializationError {
    ...
    private static List<Runner> buildRunners(Runtime runtime, CucumberExamples cucumberExamples, BecauseCucumberReporter jUnitReporter) {
